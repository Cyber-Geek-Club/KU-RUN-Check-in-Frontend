...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--]--> <button class="login-button svelte-1i2smtp" type="submit">LOGIN NOW</button> <div class="signup-section svelte-1i2smtp"><span class="signup-text svelte-1i2smtp">Don't have an account?</span> <a href="/auth/register" class="signup-link svelte-1i2smtp">Sign up</a></div></form></div></div></div></div>`);
  });
}
export {
  _page as default
