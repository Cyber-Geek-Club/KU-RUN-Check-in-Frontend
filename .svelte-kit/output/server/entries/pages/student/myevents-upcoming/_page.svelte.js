  ...
  $$renderer.component(($$renderer2) => {
    ...
    const menuItems = [
      ...
      },
      {
        id: "my-event",
        label: "My event",
        path: "/student/myevents-upcoming",
    ...
    $$renderer2.push(`<div class="app-container svelte-1gf1l8n"><header class="header-bar svelte-1gf1l8n"><div class="header-inner svelte-1gf1l8n"><div class="left-group svelte-1gf1l8n"><div class="brand svelte-1gf1l8n"><span class="brand-name svelte-1gf1l8n">STUDENT</span></div> <nav class="nav-menu desktop-only svelte-1gf1l8n"><!--[-->`);
    ...
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      ...
      $$renderer2.push(`<button${attr_class("menu-btn svelte-1gf1l8n", void 0, { "active": currentView === item.id })}><svg class="nav-icon svelte-1gf1l8n" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"${attr("d", item.svg)} class="svelte-1gf1l8n"></path></svg> <span class="btn-label svelte-1gf1l8n">${escape_html(item.label)}</span></button>`);
    }
    $$renderer2.push(`<!--]--></nav></div> <div class="search-bar-container desktop-only svelte-1gf1l8n"><div class="search-input-wrapper svelte-1gf1l8n"><svg class="search-icon active-search-icon svelte-1gf1l8n" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" class="svelte-1gf1l8n"></path></svg> <input type="text"${attr("placeholder", t[lang].search_placeholder)} class="search-input svelte-1gf1l8n"${attr("value", searchQuery)}/></div></div> <div class="user-zone svelte-1gf1l8n"><div class="timer-pill svelte-1gf1l8n">${escape_html(timeLeftStr)}</div> <div class="lang-switch desktop-only svelte-1gf1l8n"><button${attr_class("svelte-1gf1l8n", void 0, { "active": lang === "th" })}>TH</button> <span class="sep svelte-1gf1l8n">|</span> <button${attr_class("svelte-1gf1l8n", void 0, { "active": lang === "en" })}>EN</button></div> <button class="logout-btn desktop-only svelte-1gf1l8n" aria-label="Logout"><svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="svelte-1gf1l8n"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" class="svelte-1gf1l8n"></path></svg></button> <button class="mobile-toggle mobile-only svelte-1gf1l8n" aria-label="Toggle menu"><svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="svelte-1gf1l8n"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M4 9h16M4 15h16" class="svelte-1gf1l8n"></path></svg></button></div></div></header> `);
    {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> <div class="scroll-container svelte-1gf1l8n"><div class="content-wrapper svelte-1gf1l8n"><div id="upcoming-section" class="section-header-wrapper header-row svelte-1gf1l8n"><div class="header-left svelte-1gf1l8n"><h1 class="section-title svelte-1gf1l8n">${escape_html(t[lang].upcoming_header)}</h1> <div class="title-underline svelte-1gf1l8n"></div></div> <button class="jump-btn svelte-1gf1l8n">${escape_html(t[lang].history_header)} <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="svelte-1gf1l8n"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" class="svelte-1gf1l8n"></path></svg></button></div> `);
    {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div style="text-align: center; color: #94a3b8; padding: 40px;" class="svelte-1gf1l8n">Loading...</div>`);
    }
    $$renderer2.push(`<!--]--> <div id="history-section" class="section-header-wrapper header-row svelte-1gf1l8n" style="margin-top: 60px;"><div class="header-left svelte-1gf1l8n"><h1 class="section-title svelte-1gf1l8n">${escape_html(t[lang].history_header)}</h1> <div class="title-underline svelte-1gf1l8n"></div></div> <button class="jump-btn svelte-1gf1l8n">${escape_html(t[lang].upcoming_header)} <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="transform: rotate(180deg);" class="svelte-1gf1l8n"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" class="svelte-1gf1l8n"></path></svg></button></div> <div class="events-grid svelte-1gf1l8n"><!--[-->`);
    const each_array_4 = ensure_array_like(filteredHistory);
    for (let i = 0, $$length = each_array_4.length; i < $$length; i++) {
      let event = each_array_4[i];
      $$renderer2.push(`<div class="event-card svelte-1gf1l8n"><div class="card-image svelte-1gf1l8n"></div> <div class="card-content svelte-1gf1l8n"><div class="card-header-row svelte-1gf1l8n"><h3 class="card-title svelte-1gf1l8n">${escape_html(event.title)}</h3> <div class="badges-col svelte-1gf1l8n">`);
      if (event.isJoined) {
        $$renderer2.push("<!--[-->");
        $$renderer2.push(`<div style="display:flex; flex-direction:column; align-items:flex-end; gap:4px;" class="svelte-1gf1l8n"><span class="status-badge ended-normal svelte-1gf1l8n">${escape_html(t[lang].status_ended)}</span> `);
        if (event.completion_rank && event.completion_rank > 0) {
          $$renderer2.push("<!--[-->");
          $$renderer2.push(`<span class="status-badge svelte-1gf1l8n" style="background:#fbbf24; color:#78350f; border:1px solid #f59e0b; font-size:0.7rem;">🏆 ${escape_html(t[lang].rank_label)} ${escape_html(event.completion_rank)}</span>`);
        } else {
          $$renderer2.push("<!--[!-->");
        }
        $$renderer2.push(`<!--]--> <span class="status-badge svelte-1gf1l8n" style="background:#10b981; color:white; border:none; font-size:0.7rem;">🏃 ${escape_html(event.completed_count)} / ${escape_html(event.total_days)} ${escape_html(t[lang].dash_unit_days)}</span></div>`);
      } else {
        $$renderer2.push("<!--[!-->");
        $$renderer2.push(`<span class="status-badge ended-canceled svelte-1gf1l8n">CANCELED</span>`);
      }
      $$renderer2.push(`<!--]--></div></div> <p${attr_class("card-desc svelte-1gf1l8n", void 0, { "expanded": event.isExpanded })}>${escape_html(event.description)}</p> `);
      if (event.isExpanded) {
        $$renderer2.push("<!--[-->");
        ...
        $$renderer2.push(`<div class="info-grid svelte-1gf1l8n"><div class="info-pill svelte-1gf1l8n"><svg class="pill-icon svelte-1gf1l8n" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" class="svelte-1gf1l8n"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" class="svelte-1gf1l8n"></path></svg> <span class="svelte-1gf1l8n">${escape_html(event.location)}</span></div> <div class="info-pill svelte-1gf1l8n"><svg class="pill-icon svelte-1gf1l8n" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" class="svelte-1gf1l8n"></path></svg> <span class="svelte-1gf1l8n">${escape_html(getDisplayDate(event.raw_start_date, event.raw_end_date, lang))}</span></div> <div class="info-pill svelte-1gf1l8n"><svg class="pill-icon svelte-1gf1l8n" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" class="svelte-1gf1l8n"></path></svg> <span class="svelte-1gf1l8n">${escape_html(formatTime(event.raw_start_time || "", event.raw_end_time || ""))}</span></div> <div class="info-pill highlight-pill svelte-1gf1l8n"><svg class="pill-icon svelte-1gf1l8n" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" class="svelte-1gf1l8n"></path></svg> <span class="svelte-1gf1l8n">${escape_html(event.distance_km)} KM</span></div> <div class="holiday-info-box svelte-1gf1l8n"${attr_style(!hasHoliday ? "background: rgba(16, 185, 129, 0.1); border-color: #10b981;" : "")}><div class="holiday-title svelte-1gf1l8n"${attr_style(!hasHoliday ? "color: #10b981;" : "")}>${escape_html(t[lang].dash_holiday_title)}</div> <ul class="holiday-list svelte-1gf1l8n"${attr_style(!hasHoliday ? "color: #34d399;" : "")}>`);
        if (hasHoliday) {
          $$renderer2.push("<!--[-->");
          if (hConfig.excludeWeekends) {
            $$renderer2.push("<!--[-->");
            $$renderer2.push(`<li class="svelte-1gf1l8n">• ${escape_html(t[lang].dash_holiday_weekend)}</li>`);
          } else {
            $$renderer2.push("<!--[!-->");
          }
          $$renderer2.push(`<!--]--> `);
          if (hConfig.holidays) {
            ...
            for (let $$index_4 = 0, $$length2 = each_array_5.length; $$index_4 < $$length2; $$index_4++) {
              ...
              $$renderer2.push(`<li class="svelte-1gf1l8n">• ${escape_html(getDisplayDate(hDate, void 0, lang))}</li>`);
            }
            $$renderer2.push(`<!--]-->`);
          } else {
            $$renderer2.push("<!--[!-->");
          ...
          $$renderer2.push("<!--[!-->");
          $$renderer2.push(`<li class="svelte-1gf1l8n">${escape_html(t[lang].dash_no_holiday)}</li>`);
        }
        $$renderer2.push(`<!--]--></ul></div></div>`);
      } else {
        $$renderer2.push("<!--[!-->");
      }
      $$renderer2.push(`<!--]--> <div class="card-footer-actions svelte-1gf1l8n"><button class="dashboard-text-btn svelte-1gf1l8n"><svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="svelte-1gf1l8n"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" class="svelte-1gf1l8n"></path></svg> <span class="svelte-1gf1l8n">${escape_html("ผลสรุป")}</span></button> `);
      if (event.isJoined) {
        $$renderer2.push("<!--[-->");
        $$renderer2.push(`<button class="status-btn completed-btn svelte-1gf1l8n" style="cursor: default; box-shadow: none;">COMPLETED</button>`);
      } else {
        $$renderer2.push("<!--[!-->");
        $$renderer2.push(`<button class="status-btn canceled-btn svelte-1gf1l8n" style="cursor: default; box-shadow: none;">CANCELED</button>`);
      }
      $$renderer2.push(`<!--]--></div></div></div>`);
    }
    $$renderer2.push(`<!--]--></div> <footer class="app-footer svelte-1gf1l8n"><div class="footer-separator svelte-1gf1l8n"></div> <div class="footer-content svelte-1gf1l8n"><p class="copyright svelte-1gf1l8n">© 2025 Cyber Geek. All rights reserved.</p> <p class="credits svelte-1gf1l8n">Designed &amp; Developed by <span class="highlight svelte-1gf1l8n">Cyber Geek Development</span></p> <p class="contact svelte-1gf1l8n">Contact: <a href="mailto:cybergeek.dev@proton.me" class="svelte-1gf1l8n">cybergeek.dev@proton.me</a></p></div></footer></div></div> `);
    {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> `);
