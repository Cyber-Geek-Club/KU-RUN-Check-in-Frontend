...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="app-container svelte-15yjt40"><header class="header-bar svelte-15yjt40"><div class="header-inner svelte-15yjt40"><div class="left-group svelte-15yjt40"><div class="brand"><span class="brand-name svelte-15yjt40">STUDENT</span></div> <nav class="nav-menu desktop-only svelte-15yjt40"><!--[-->`);
    const each_array = ensure_array_like(menuItems);
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      let item = each_array[$$index];
      $$renderer2.push(`<button${attr_class("menu-btn svelte-15yjt40", void 0, { "active": currentView === item.id })}><svg class="nav-icon svelte-15yjt40" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"${attr("d", item.svg)}></path></svg> <span class="btn-label">${escape_html(item.label)}</span></button>`);
    }
    $$renderer2.push(`<!--]--></nav></div> <div class="search-bar-container desktop-only svelte-15yjt40"><div class="search-input-wrapper svelte-15yjt40"><svg class="search-icon svelte-15yjt40" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg> <input type="text"${attr("placeholder", t[lang].search_placeholder)} class="search-input svelte-15yjt40"${attr("value", searchQuery)}/></div></div> <div class="user-zone svelte-15yjt40"><div class="timer-pill svelte-15yjt40">${escape_html(timeLeftStr)}</div> <div class="lang-switch desktop-only svelte-15yjt40"><button${attr_class("svelte-15yjt40", void 0, { "active": lang === "th" })}>TH</button> <span class="sep svelte-15yjt40">|</span> <button${attr_class("svelte-15yjt40", void 0, { "active": lang === "en" })}>EN</button></div> <button class="logout-btn desktop-only svelte-15yjt40" aria-label="Logout"><svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path></svg></button> <button class="mobile-toggle mobile-only svelte-15yjt40" aria-label="Toggle menu"><svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M4 9h16M4 15h16"></path></svg></button></div></div></header> `);
    {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> <div class="scroll-container svelte-15yjt40"><div class="content-wrapper svelte-15yjt40"><div class="page-header svelte-15yjt40"><h2 class="section-title svelte-15yjt40">Event List</h2> <div class="title-underline svelte-15yjt40"></div></div> `);
    {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="loading-container svelte-15yjt40"><div class="spinner svelte-15yjt40"></div> <p>Loading...</p></div>`);
    }
    $$renderer2.push(`<!--]--> <footer class="app-footer svelte-15yjt40"><div class="footer-separator svelte-15yjt40"></div> <div class="footer-content svelte-15yjt40"><p class="copyright svelte-15yjt40">© 2025 Cyber Geek. All rights reserved.</p> <p class="credits svelte-15yjt40">Designed &amp; Developed by <span class="highlight svelte-15yjt40">Cyber Geek Development</span></p> <p class="contact svelte-15yjt40">Contact: <a href="mailto:cybergeek.dev@proton.me" class="svelte-15yjt40">cybergeek.dev@proton.me</a></p></div></footer></div></div> `);
    {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> `);
