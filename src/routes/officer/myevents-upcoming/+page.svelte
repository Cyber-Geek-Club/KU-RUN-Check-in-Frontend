<script lang="ts">
  ...
  // --- STATE: LANGUAGE ---
  let lang: 'th' | 'en' = 'th';
<!-- Officer myevents-upcoming page: FULL COPY of student version for parity, ready for officer-specific adjustments. -->
<script lang="ts">
  import { fade, slide, scale } from "svelte/transition";
  import { goto } from "$app/navigation";
  import { auth } from "$lib/utils/auth";
  ...
  const t = {
      th: {
          ...
          read_less: "ย่อลง",
          // ... (rest of the translation object from student page) ...
      },
      en: {
  ...
  // ... (rest of the student myevents-upcoming/+page.svelte code, unchanged) ...
</script>

<!-- The rest of the file is a direct copy of the student myevents-upcoming/+page.svelte, to be adapted for officer context next. -->
