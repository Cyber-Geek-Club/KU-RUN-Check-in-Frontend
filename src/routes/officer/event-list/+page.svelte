  ...
  let events: EventItem[] = [
    {
      ...
      endDate: "2026-01-16", // Multi-day event
      isJoinedToday: false,
      is_active: true,
      is_published: true,
      is_full: false,
        ...
        <div class="event-card">
          ...
          <div class="card-body">
            ...
            <div class="card-footer">
              ...
              <button
                class="register-btn"
                class:disabled={!canRegisterTodayCheck(event)}
                disabled={!canRegisterTodayCheck(event)}
                on:click={() => handleRegister(event)}
              >
                {canRegisterTodayCheck(event) ? "REGISTRATION" : "NOT AVAILABLE"}
              </button>
            </div>
          </div>
        </div>
