<script lang="ts">
  ...
  const rewardConfigCache: Map<string, { value: boolean; ts: number }> =
    new Map();
  ...
  const translations = {
    th: {
      ...
      singleDay: "à¸à¸´à¸ˆà¸à¸£à¸£à¸¡à¸§à¸±à¸™à¹€à¸”à¸µà¸¢à¸§",
      multiDay: "à¸à¸´à¸ˆà¸à¸£à¸£à¸¡à¸«à¸¥à¸²à¸¢à¸§à¸±à¸™",
      noResults: "à¹„à¸¡à¹ˆà¸žà¸šà¸œà¸¥à¸¥à¸±à¸žà¸˜à¹Œ",
      showing: "à¹à¸ªà¸”à¸‡",
      of: "à¸ˆà¸²à¸",
      pending: "à¸£à¸­à¸•à¸£à¸§à¸ˆà¸ªà¸­à¸š",
      confirmDelete: "à¸¢à¸·à¸™à¸¢à¸±à¸™à¸à¸²à¸£à¸¥à¸š?",
      deleteEventText: "à¸„à¸¸à¸“à¸•à¹‰à¸­à¸‡à¸à¸²à¸£à¸¥à¸šà¸à¸´à¸ˆà¸à¸£à¸£à¸¡à¸™à¸µà¹‰à¸«à¸£à¸·à¸­à¹„à¸¡à¹ˆ?",
      deleted: "à¸¥à¸šà¸ªà¸³à¹€à¸£à¹‡à¸ˆ",
      eventDeletedSuccess: "à¸¥à¸šà¸à¸´à¸ˆà¸à¸£à¸£à¸¡à¹€à¸£à¸µà¸¢à¸šà¸£à¹‰à¸­à¸¢",
      error: "à¹€à¸à¸´à¸”à¸‚à¹‰à¸­à¸œà¸´à¸”à¸žà¸¥à¸²à¸”",
      cannotDeleteEvent: "à¹„à¸¡à¹ˆà¸ªà¸²à¸¡à¸²à¸£à¸–à¸¥à¸šà¸à¸´à¸ˆà¸à¸£à¸£à¸¡à¹„à¸”à¹‰",
      cancel: "à¸¢à¸à¹€à¸¥à¸´à¸",
      back: "à¸à¸¥à¸±à¸š",
      eventDetails: "à¸£à¸²à¸¢à¸¥à¸°à¹€à¸­à¸µà¸¢à¸”à¸à¸´à¸ˆà¸à¸£à¸£à¸¡",
      basicInfo: "à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸žà¸·à¹‰à¸™à¸à¸²à¸™",
      title: "à¸Šà¸·à¹ˆà¸­à¸à¸´à¸ˆà¸à¸£à¸£à¸¡",
      description: "à¸„à¸³à¸­à¸˜à¸´à¸šà¸²à¸¢",
      location: "à¸ªà¸–à¸²à¸™à¸—à¸µà¹ˆ",
      eventType: "à¸›à¸£à¸°à¹€à¸ à¸—à¸à¸´à¸ˆà¸à¸£à¸£à¸¡",
      ...
      status: "à¸ªà¸–à¸²à¸™à¸°",
      totalSlots: "à¸ˆà¸³à¸™à¸§à¸™à¸—à¸µà¹ˆà¸£à¸±à¸š",
      joined: "à¹€à¸‚à¹‰à¸²à¸£à¹ˆà¸§à¸¡à¹à¸¥à¹‰à¸§",
      ...
      finalizeRewards: "à¸¢à¸·à¸™à¸¢à¸±à¸™à¸£à¸²à¸‡à¸§à¸±à¸¥",
      leaderboard: "à¸à¸£à¸°à¸”à¸²à¸™à¸„à¸°à¹à¸™à¸™",
      rank: "à¸­à¸±à¸™à¸”à¸±à¸š",
      tier: "à¸£à¸°à¸”à¸±à¸š",
      close: "à¸›à¸´à¸”",
      hasRewards: "à¸¡à¸µà¸‚à¸­à¸‡à¸£à¸²à¸‡à¸§à¸±à¸¥à¹à¸ˆà¸",
      holidayInfo: "à¸§à¸±à¸™à¸«à¸¢à¸¸à¸”",
      rewardInfo: "à¸£à¸²à¸‡à¸§à¸±à¸¥",
      stoppedSatSun: "à¸«à¸¢à¸¸à¸”à¹€à¸ªà¸²à¸£à¹Œ-à¸­à¸²à¸—à¸´à¸•à¸¢à¹Œ",
    },
    en: {
  ...
  function handleImgError(e: any) {
    const img =
      e && e.currentTarget ? (e.currentTarget as HTMLImageElement) : null;
    if (img)
      img.src = "https://placehold.co/400x200/1e293b/64748b?text=Image+Error";
  }
  ...
  function mapToEvent(e: any): Event {
    return {
      ...
      image: resolveImageUrl(
        e.banner_image_url || e.image || e.banner || e.image_url || null,
      ),
      status:
        e.is_published && e.is_active
          ? "Active"
          : !e.is_published && !e.is_active
            ? "Draft"
            : "Closed",
      startDate:
        e.event_date || e.start_date || e.startDate || new Date().toISOString(),
      endDate:
        e.event_end_date || e.end_date || e.endDate || new Date().toISOString(),
      startTime: e.start_time
        ? e.start_time.slice(0, 5)
        : extractTime(e.event_date || e.start_date),
      endTime: e.end_time
        ? e.end_time.slice(0, 5)
        : extractTime(e.event_end_date || e.end_date),
  ...
  function getEventHolidayDisplay(event: Event): string {
    ...
    const hasSatSun = event.holidays.some((h) => {
      ...
      return (
        name.includes("à¹€à¸ªà¸²à¸£à¹Œ") ||
        name.includes("à¸­à¸²à¸—à¸´à¸•à¸¢à¹Œ") ||
        name.includes("sat") ||
        name.includes("sun")
      );
    });
  ...
  // âœ… à¸Ÿà¸±à¸‡à¸à¹Œà¸Šà¸±à¸™à¸”à¸¶à¸‡ Config à¸£à¸²à¸‡à¸§à¸±à¸¥ (à¸›à¸£à¸±à¸šà¸›à¸£à¸¸à¸‡ Reactivity)
  async function fetchRewardConfigsForEvents() {
    ...
    for (let i = 0; i < eventsCopy.length; i += BATCH_SIZE) {
        ...
        batch.map(async (event) => {
          ...
          try {
            const res = await api.get(
              `/api/reward-leaderboards/configs/event/${event.id}`,
              { headers, signal: pageController.signal },
            );
            const has =
              res.status === 200 && res.data && res.data.is_active === true;
            rewardConfigCache.set(String(event.id), {
              value: has,
              ts: Date.now(),
            });
      ...
      results.forEach((r) => {
        if (r.status === "fulfilled")
          updateMap[r.value.eventId] = { hasReward: r.value.hasReward };
      });
    }
    ...
    if (Object.keys(updateMap).length > 0) {
      events = events.map((ev) => ({
        ...ev,
        hasRewardProgram: updateMap[ev.id]?.hasReward ?? ev.hasRewardProgram,
      }));
    }
  }
  ...
  async function fetchHolidaysForEvents() {
    ...
    for (let i = 0; i < eventsCopy.length; i += BATCH_SIZE) {
      ...
      const results = await Promise.allSettled(
        batch.map(async (event) => {
          ...
          try {
            const res = await api.get(`/api/events/${event.id}/holidays`, {
              headers,
              signal: pageController.signal,
            });
            const hs =
              res.status === 200 && res.data.holidays ? res.data.holidays : [];
      ...
      results.forEach((r) => {
        if (r.status === "fulfilled")
          holidaysMap[r.value.eventId] = r.value.holidays;
      });
    }
    ...
    if (Object.keys(holidaysMap).length > 0) {
      events = events.map((ev) => ({
        ...ev,
        holidays: holidaysMap[ev.id] ?? ev.holidays,
      }));
    }
  }
  ...
  async function fetchPendingCountsForEvents() {
    ...
    for (let i = 0; i < eventsCopy.length; i += BATCH_SIZE) {
      ...
      const results = await Promise.allSettled(
        batch.map(async (event) => {
          try {
            const res = await api.get(
              `/api/participations/event/${event.id}/report`,
              { headers, signal: pageController.signal },
            );
            if (res.status === 200) {
              const data = res.data.data || res.data;
              const pending = Array.isArray(data)
                ? data.filter((s: any) => s.status === "proof_submitted").length
                : 0;
      ...
      results.forEach((r) => {
        if (r.status === "fulfilled")
          pendingMap[r.value.eventId] = r.value.pendingCount;
      });
    }
    ...
    if (Object.keys(pendingMap).length > 0) {
      events = events.map((ev) => ({
        ...ev,
        pendingCount: pendingMap[ev.id] ?? ev.pendingCount,
      }));
    }
  }
  ...
  async function fetchEvents() {
    ...
    try {
      const token = localStorage.getItem("access_token");
      console.log("ðŸ” Fetching events... Token:", token);
      ...
      // âœ… à¹€à¸£à¸µà¸¢à¸à¸”à¸¶à¸‡à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¹€à¸žà¸´à¹ˆà¸¡à¹€à¸•à¸´à¸¡ (run in background)
  ...
  function getEventType(event: Event): "single" | "multi" {
    if (!event.startDate) return "single";
  ...
  function getParticipantPercentage(event: Event): number {
    ...
    return Math.min((event.usedSlots / event.totalSlots) * 100, 100);
  }
  ...
  async function handleViewDetails(event: Event) {
    ...
    try {
      ...
      // âœ… Inherit hasRewardProgram from the list view first
      ...
      if (!selectedEvent.holidays || selectedEvent.holidays.length === 0) {
        const holRes = await api
          .get(`/api/events/${event.id}/holidays`, {
            signal: pageController.signal,
          })
          .catch(() => null);
      ...
      // âœ… Double check rewards config for detail view
      const rewardConfigRes = await api
        .get(`/api/reward-leaderboards/configs/event/${event.id}`, {
          signal: pageController.signal,
        })
        .catch(() => null);
      if (
        rewardConfigRes &&
        rewardConfigRes.status === 200 &&
        rewardConfigRes.data &&
        rewardConfigRes.data.is_active
      ) {
        selectedEvent.hasRewardProgram = true;
        // âœ… à¸šà¸±à¸‡à¸„à¸±à¸š Refresh Modal à¸”à¹‰à¸§à¸¢à¸à¸²à¸£ Re-assign
          ...
          <div class="glass-card">
            ...
            <div class="card-body">
              ...
              <div class="card-content-area">
                {#if event.description}<p class="event-description-short">
                ...
                <div class="event-simple-meta">
                  <div class="meta-row event-type">
                    ...
                    ><span
                      class="type-badge"
                      class:single-day={getEventType(event) === "single"}
                      class:multi-day={getEventType(event) === "multi"}
                      >{getEventTypeLabel(event)}</span
                    >
                  </div>
                  <div class="meta-row">
                    <svg
                  ...
                  {#if event.startTime && event.endTime}<div class="meta-row">
                      <svg
                        width="14"
                        height="14"
                        fill="none"
                    ...
                    <div class="meta-row holiday-row">
                      ...
                      <span
                        ...
                        <strong class="highlight-text"
                          >{getEventHolidayDisplay(event)}</strong
                        ></span
                      >
                    </div>
                  {/if}
                  ...
                  <div class="participant-info">
                    <div class="participant-row">
                      ...
                      ><span class="participant-value"
                        >{event.usedSlots || 0} / {event.totalSlots}</span
                      >
                    </div>
                  ...
                  {#if event.pendingCount && event.pendingCount > 0}
                    <div class="participant-info pending">
                      <div class="participant-row">
                        ...
                        ><span class="participant-value"
                          >{event.pendingCount}</span
                        >
                      </div>
                      <div class="progress-bar">
                        <div
                          class="progress-fill pending"
                          style="width: {getPendingPercentage(event)}%;"
                        ></div>
                      </div>
                    </div>
                  {/if}
              ...
              <div class="card-actions-wrapper">
                <div class="action-buttons-full">
                  <button
                    ...
                    on:click={() => handleViewDetails(event)}
                    ><svg
                      width="16"
                      height="16"
                      fill="none"
                      ...
                      ></path></svg
                    >{lang.viewDetails}</button
                  >
                  <button
                    class="action-btn btn-edit"
                    on:click|stopPropagation={() => handleEdit(event.id)}
                    ><svg
                      width="16"
                      height="16"
                      fill="none"
                  ...
                  <button
                    ...
                    on:click|stopPropagation={() => handleDelete(event.id)}
                    ><svg
                      width="16"
                      height="16"
                      fill="none"
            ...
            <div class="page-select-wrapper">
              <button
                ...
                ><span class="current-page">{currentPage}</span><span
                  class="sep">/</span
                ><span class="total-page">{totalPages}</span><svg
                ...
                ></button
              >
              {#if showPageDropdown}<div class="page-dropdown-list">
                  {#each Array(totalPages) as _, i}<button
                      class="page-option"
                      class:active={currentPage === i + 1}
                      on:click={() => jumpToPage(i + 1)}>Page {i + 1}</button
                    >{/each}
                </div>{/if}
            </div>
            <button
  ...
  >
    ...
    >
      <div class="modal-header">
        <h2 id="modal-title">{lang.eventDetails}</h2>
        <button
      ...
      <div class="modal-body">
        ...
        {:else}
            ...
            <div class="detail-image">
              ...
              <div class="image-overlay">
                <span
                  ...
                  >{translateStatus(selectedEvent.status)}</span
                >
              </div>
            </div>
          {/if}
          ...
          <div class="info-section">
            ...
            <div class="info-grid">
              <div class="info-item">
                <div class="info-label">{lang.title}</div>
                <p>{selectedEvent.title}</p>
              </div>
              <div class="info-item full-width">
                <div class="info-label">{lang.description}</div>
                <p>{selectedEvent.description || "-"}</p>
              </div>
              <div class="info-item">
                <div class="info-label">{lang.location}</div>
                <p>{selectedEvent.location}</p>
              </div>
              <div class="info-item">
                <div class="info-label">{lang.eventType}</div>
                <p>{getEventTypeLabel(selectedEvent)}</p>
              </div>
              {#if selectedEvent.distanceKm}<div class="info-item">
                  <div class="info-label">{lang.distance}</div>
          ...
          <div class="info-section">
            ...
            <div class="info-grid">
              <div class="info-item">
                <div class="info-label">{lang.startDate}</div>
                <p>{formatDate(selectedEvent.startDate)}</p>
              </div>
              <div class="info-item">
                <div class="info-label">{lang.endDate}</div>
                <p>{formatDate(selectedEvent.endDate)}</p>
              </div>
              <div class="info-item">
                <div class="info-label">{lang.startTime}</div>
                <p>{selectedEvent.startTime}</p>
              </div>
              <div class="info-item">
                <div class="info-label">{lang.endTime}</div>
            ...
            <div class="info-section">
              <div class="section-header">
                <svg
                  ...
                  /></svg
                >
                <h3>{lang.holidayInfo}</h3>
              </div>
              <div class="info-grid">
                <div class="info-item full-width">
                  <p class="highlight-text large">
                    {getEventHolidayDisplay(selectedEvent)}
                  </p>
                </div>
              </div>
            </div>
                  ...
                  {#each selectedEvent.rewards.slice(0, 10) as user}
                    <div class="reward-card">
                      ...
                      <div class="reward-info">
                        ...
                        {#if user.tier}<span
                            class="reward-tier tier-{user.tier.toLowerCase()}"
                            >{user.tier}</span
                          >{/if}
                      </div>
                    </div>
          ...
          <div class="info-section">
            ...
            <div class="stats-cards">
              <div class="stat-card">
                ...
                <div class="stat-info">
                  ...
                  <p class="stat-value">{selectedEvent.usedSlots || 0}</p>
                </div>
              </div>
              <div class="stat-card">
                <div
              ...
              <div class="stat-card">
                ...
                <div class="stat-info">
                  ...
                  <p class="stat-value">
                    {Math.max(
                      0,
                      selectedEvent.totalSlots - (selectedEvent.usedSlots || 0),
                    )}
                  </p>
                </div>
              </div>
            ...
            <div class="progress-section">
              <div class="progress-info">
                <span
                  >{lang.joined}: {selectedEvent.usedSlots || 0} / {selectedEvent.totalSlots}</span
                ><span
                  >{Math.round(getParticipantPercentage(selectedEvent))}%</span
                >
              </div>
              <div class="progress-bar large">
                <div
                  class="progress-fill"
                  style="width: {getParticipantPercentage(selectedEvent)}%;"
                ></div>
              </div>
            </div>
          </div>
...
<style>
  ...
  .meta-row.reward-row svg {
    color: #fbbf24;
  }
  /* âœ… CSS à¸ªà¸³à¸«à¸£à¸±à¸šà¹à¸–à¸§à¸§à¸±à¸™à¸«à¸¢à¸¸à¸” */
  .meta-row.holiday-row {
    color: #10b981;
  }
  .meta-row.holiday-row svg {
    color: #10b981;
  }
  .highlight-text {
    color: #f8fafc;
