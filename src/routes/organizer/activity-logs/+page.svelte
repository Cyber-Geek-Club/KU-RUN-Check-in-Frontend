      ...
      <div class="detail-modal-body">
        ...
        <div class="participation-history-section">
          <h3 class="section-title">
            ...
            {#if selectedParticipant.isLoadingDetails}
              <div
                class="ml-auto inline-flex items-center text-sm text-gray-400"
              >
                <svg
...
<style>
  ...
  .modal-overlay {
    ...
    align-items: center;
    padding: 1rem;
    /* animation: fadeIn 0.2s; REMOVED FOR INSTANT OPEN */
  }
  .detail-modal {
    background: #1e293b;
    width: 100%;
    ...
    /* animation: slideUp 0.3s; REMOVED FOR INSTANT OPEN */
    overflow: hidden;
  }
  .detail-modal-header {
    padding: 1.5rem 2rem;
